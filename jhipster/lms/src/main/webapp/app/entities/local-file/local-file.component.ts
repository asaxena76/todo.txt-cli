...
export class LocalFileComponent implements OnInit, OnDestroy {
    ...
    trackId (index: number, item: LocalFile) {
        return item.id;
    }
    ...
    registerChangeInLocalFiles() {
        this.eventSubscriber = this.eventManager.subscribe('localFileListModification', (response) => this.reset());
    }
